...
\begin{figure}
  ...
  \begin{minipage}{\textwidth}
    \leftfigure[t]{\includegraphics[width=0.4\textwidth]{n-queens/assignment.pdf}}
    \hspace{\fill}
    \rightfigure[t]{\includegraphics[width=0.4\textwidth]{n-queens/permutation.pdf}}
  \end{minipage}
...
\begin{figure}
  \subfigures 
  \begin{minipage}{\textwidth}
    \leftfigure[t]{\includegraphics[width=0.4\textwidth]{n-queens/assignment_change.pdf}}
    \hspace{\fill}
    \rightfigure[t]{\includegraphics[width=0.4\textwidth]{n-queens/permutation_swap.pdf}}
  \end{minipage}
...
procedure employs some specific mechanism for escaping them (see, e.g., Chapter\label{chp:simulated-annealing}),
