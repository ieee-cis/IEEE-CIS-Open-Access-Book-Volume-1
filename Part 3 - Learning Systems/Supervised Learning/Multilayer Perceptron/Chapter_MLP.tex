...
% Introdução. É recomendável ver o arquivo "original.tex" com instruções sobre a escrita.

% \textbf{Hugo Valadares:} "Um capítulo de MLP bem direto. Falar do neurônio básico, função de ativação, como se monta a rede e como treina. Acho bom colocar as equações do backprop. E as figuras vcs podem se dividir. Importante uma do neurônio e uma da rede.".
